...
class TestIntegracaoCompletos(unittest.TestCase):
    ...
    def test_precisao_calculos_cenarios_conhecidos(self):
        ...
        # Patrimônio final esperado: valor - saldo devedor + aluguel acumulado - entrada
        # Baseado na implementação real: aproximadamente 85333.33
        valor_esperado_imovel = 85333.33
        ...
        # Baseado na implementação real: aproximadamente 79333.33
        valor_esperado_misto = 79333.33
    ...
    def test_tratamento_erros_integracao(self):
        ...
        with self.assertRaises((ParametroInvalidoError, OtimizacaoError)):
